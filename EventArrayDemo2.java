...
public class EventArrayDemo2
{
   public static void main(String[] args)
   {
      ...
      int x;
      //below is a for loop to prepare to display the available choices
      ...
      for(x = 0; x < someEvents.length; ++x)
      {
         strSelectedEvent = JOptionPane.showInputDialog(null,
            "Event # " + (x + 1) + 
            "Enter the number the type of event you want" + 
            choicesString);
      ...
      for(x = 0; x < someEvents.length; ++x)
      {
      //directly below the 1st method call is a call to the array 
      //to get the name in the x position
