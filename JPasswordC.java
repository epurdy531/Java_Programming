...
public class JPasswordC extends JApplet implements ActionListener
{
   ...
   public void actionPerformed(ActionEvent e)
   {
      ...
      if(userPassword.equalsIgnoreCase("Rosebud")||
         userPassword.equalsIgnoreCase("Redrum")||
         userPassword.equalsIgnoreCase("Jason")||
         userPassword.equalsIgnoreCase("Surrender")||
         userPassword.equalsIgnoreCase("Dorothy"))
      {
